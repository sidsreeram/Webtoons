...
import (
	...
	interfaces "github.com/webtoons/pkg/usecase/interfaces"
)

type WebtoonHandler struct {
	WebtoonUC interfaces.WebtoonUseCase
}

func NewWebtoonHandler(webtoonUC interfaces.WebtoonUseCase) *WebtoonHandler {
